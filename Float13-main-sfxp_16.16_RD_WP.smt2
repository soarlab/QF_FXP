...
(assert (= (sfxp.div Wrapping roundTowardNegative (sfxp #x00010000 16) (sfxp #x00000000 16)) |c::plus_infinity&0#1|))
(assert (= (sfxp.div Wrapping roundTowardNegative (sfxp #x00000000 16) (sfxp.neg Wrapping (sfxp #x00000000 16))) |c::minus_infinity&0#1|))
(assert (= (sfxp.mul Wrapping roundTowardNegative (sfxp #x00000000 16) (sfxp.div Wrapping roundTowardNegative (sfxp #x00010000 16) (sfxp #x00000000 16))) |c::NaN&0#1|))
