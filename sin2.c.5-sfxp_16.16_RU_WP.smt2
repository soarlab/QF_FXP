...
(define-fun _t_62 () (_ SFXP 32 16) (sfxp.add wrapAround _t_9 _t_16))
(define-fun _t_63 () (_ SFXP 32 16) (sfxp.add wrapAround _t_24 _t_62))
(define-fun _t_64 () (_ SFXP 32 16) (sfxp.add wrapAround _t_32 _t_63))
(define-fun _t_65 () (_ SFXP 32 16) (sfxp.add wrapAround _t_40 _t_64))
(define-fun _t_66 () (_ SFXP 32 16) (sfxp.add wrapAround _t_48 _t_65))
...
(define-fun _t_78 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_9))
...
(define-fun _t_85 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_52))
...
(define-fun _t_133 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_48))
...
(define-fun _t_140 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_40))
...
(define-fun _t_147 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_32))
...
(define-fun _t_154 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_24))
...
(define-fun _t_161 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_16))
