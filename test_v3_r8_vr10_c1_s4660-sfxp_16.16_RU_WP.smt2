...
(define-fun _t_28 () (_ SFXP 32 16) ((_ sfxp 16) #x0000db22))
(define-fun _t_31 () (_ SFXP 32 16) ((_ sfxp 16) #x00003be7))
...
(define-fun _t_36 () (_ SFXP 32 16) ((_ sfxp 16) #x00007062))
...
(define-fun _t_41 () (_ SFXP 32 16) ((_ sfxp 16) #x0000ce97))
...
(assert _t_44)
(define-fun _t_47 () (_ SFXP 32 16) ((_ sfxp 16) #x00005126))
(define-fun _t_50 () (_ SFXP 32 16) ((_ sfxp 16) #x00004b02))
...
(define-fun _t_55 () (_ SFXP 32 16) ((_ sfxp 16) #x00003126))
(define-fun _t_56 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_17 _t_55))
(define-fun _t_57 () (_ SFXP 32 16) (sfxp.add wrapAround _t_52 _t_56))
(define-fun _t_59 () (_ SFXP 32 16) ((_ sfxp 16) #x00001020))
(define-fun _t_60 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_21 _t_59))
(define-fun _t_61 () (_ SFXP 32 16) (sfxp.add wrapAround _t_57 _t_60))
(define-fun _t_62 () Bool (sfxp.leq _t_61 _t_47))
(assert _t_62)
(define-fun _t_64 () (_ SFXP 32 16) ((_ sfxp 16) #x0000d22d))
(define-fun _t_67 () (_ SFXP 32 16) ((_ sfxp 16) #x00006b43))
...
(define-fun _t_72 () (_ SFXP 32 16) ((_ sfxp 16) #x0000fa5e))
...
(define-fun _t_76 () (_ SFXP 32 16) ((_ sfxp 16) #x0000a041))
...
(assert _t_79)
(define-fun _t_81 () (_ SFXP 32 16) ((_ sfxp 16) #x0000e2d0))
(define-fun _t_83 () (_ SFXP 32 16) ((_ sfxp 16) #x0000eb85))
...
(define-fun _t_88 () (_ SFXP 32 16) ((_ sfxp 16) #x0000ea7e))
...
(define-fun _t_92 () (_ SFXP 32 16) ((_ sfxp 16) #x0000d851))
...
(assert _t_95)
(define-fun _t_98 () (_ SFXP 32 16) ((_ sfxp 16) #x00006e56))
(define-fun _t_101 () (_ SFXP 32 16) ((_ sfxp 16) #x00001a1c))
(define-fun _t_102 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_13 _t_101))
(define-fun _t_103 () (_ SFXP 32 16) (sfxp.add wrapAround _t_26 _t_102))
(define-fun _t_106 () (_ SFXP 32 16) ((_ sfxp 16) #x00008c8b))
(define-fun _t_107 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_17 _t_106))
(define-fun _t_108 () (_ SFXP 32 16) (sfxp.add wrapAround _t_103 _t_107))
(define-fun _t_110 () (_ SFXP 32 16) ((_ sfxp 16) #x000077ce))
(define-fun _t_111 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_21 _t_110))
(define-fun _t_112 () (_ SFXP 32 16) (sfxp.add wrapAround _t_108 _t_111))
(define-fun _t_113 () Bool (sfxp.leq _t_112 _t_98))
(assert _t_113)
(define-fun _t_116 () (_ SFXP 32 16) ((_ sfxp 16) #x0000645a))
(define-fun _t_118 () (_ SFXP 32 16) ((_ sfxp 16) #x000063d7))
(define-fun _t_119 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_13 _t_118))
(define-fun _t_120 () (_ SFXP 32 16) (sfxp.add wrapAround _t_26 _t_119))
(define-fun _t_122 () (_ SFXP 32 16) ((_ sfxp 16) #x0000d168))
...
(define-fun _t_126 () (_ SFXP 32 16) ((_ sfxp 16) #x00007a1c))
...
(assert _t_129)
(define-fun _t_131 () (_ SFXP 32 16) ((_ sfxp 16) #x0000ca3d))
(define-fun _t_133 () (_ SFXP 32 16) ((_ sfxp 16) #x00002189))
(define-fun _t_134 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_13 _t_133))
(define-fun _t_135 () (_ SFXP 32 16) (sfxp.add wrapAround _t_26 _t_134))
(define-fun _t_137 () (_ SFXP 32 16) ((_ sfxp 16) #x0000bae1))
...
(define-fun _t_142 () (_ SFXP 32 16) ((_ sfxp 16) #x0000dd2f))
(define-fun _t_143 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_21 _t_142))
(define-fun _t_144 () (_ SFXP 32 16) (sfxp.add wrapAround _t_139 _t_143))
(define-fun _t_145 () Bool (sfxp.leq _t_131 _t_144))
(assert _t_145)
(define-fun _t_147 () (_ SFXP 32 16) ((_ sfxp 16) #x00002f9d))
(define-fun _t_149 () (_ SFXP 32 16) ((_ sfxp 16) #x00000d4f))
(define-fun _t_150 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_13 _t_149))
(define-fun _t_151 () (_ SFXP 32 16) (sfxp.add wrapAround _t_26 _t_150))
(define-fun _t_153 () (_ SFXP 32 16) ((_ sfxp 16) #x00002147))
...
(define-fun _t_158 () (_ SFXP 32 16) ((_ sfxp 16) #x00008b85))
