...
(define-fun _t_56 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_25 _t_55))
(define-fun _t_57 () (_ SFXP 32 16) (sfxp.add Wrapping _t_52 _t_56))
(define-fun _t_60 () (_ SFXP 32 16) (sfxp #x00006fdf 16))
(define-fun _t_61 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_29 _t_60))
...
(define-fun _t_148 () (_ SFXP 32 16) (sfxp.add Wrapping _t_34 _t_147))
...
(define-fun _t_209 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_21 _t_208))
(define-fun _t_210 () (_ SFXP 32 16) (sfxp.add Wrapping _t_206 _t_209))
(define-fun _t_213 () (_ SFXP 32 16) (sfxp #x00007ef9 16))
(define-fun _t_214 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_25 _t_213))
(define-fun _t_215 () (_ SFXP 32 16) (sfxp.add Wrapping _t_210 _t_214))
(define-fun _t_218 () (_ SFXP 32 16) (sfxp #x0000570a 16))
(define-fun _t_219 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_29 _t_218))
(define-fun _t_220 () (_ SFXP 32 16) (sfxp.add Wrapping _t_215 _t_219))
...
(define-fun _t_281 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_13 _t_280))
(define-fun _t_282 () (_ SFXP 32 16) (sfxp.add Wrapping _t_34 _t_281))
(define-fun _t_284 () (_ SFXP 32 16) (sfxp #x0000d439 16))
(define-fun _t_285 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_17 _t_284))
(define-fun _t_286 () (_ SFXP 32 16) (sfxp.add Wrapping _t_282 _t_285))
(define-fun _t_287 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_12 _t_21))
(define-fun _t_288 () (_ SFXP 32 16) (sfxp.add Wrapping _t_286 _t_287))
(define-fun _t_290 () (_ SFXP 32 16) (sfxp #x00007ba5 16))
(define-fun _t_291 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_25 _t_290))
(define-fun _t_292 () (_ SFXP 32 16) (sfxp.add Wrapping _t_288 _t_291))
(define-fun _t_295 () (_ SFXP 32 16) (sfxp #x00003ba5 16))
(define-fun _t_296 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_29 _t_295))
