...
(define-fun _t_98 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_21 _t_97))
...
(define-fun _t_107 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_29 _t_106))
...
(define-fun _t_180 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_25 _t_179))
...
(define-fun _t_196 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_17 _t_195))
...
(define-fun _t_250 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_17 _t_249))
(define-fun _t_251 () (_ SFXP 32 16) (sfxp.add Wrapping _t_247 _t_250))
(define-fun _t_253 () (_ SFXP 32 16) (sfxp #x0000dc6a 16))
(define-fun _t_254 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_21 _t_253))
...
(define-fun _t_270 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_13 _t_269))
...
(define-fun _t_345 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_13 _t_344))
(define-fun _t_346 () (_ SFXP 32 16) (sfxp.add Wrapping _t_34 _t_345))
(define-fun _t_349 () (_ SFXP 32 16) (sfxp #x0000a189 16))
(define-fun _t_350 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_17 _t_349))
...
(define-fun _t_363 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_29 _t_362))
...
(define-fun _t_371 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_13 _t_370))
(define-fun _t_372 () (_ SFXP 32 16) (sfxp.add Wrapping _t_34 _t_371))
(define-fun _t_374 () (_ SFXP 32 16) (sfxp #x00006c49 16))
(define-fun _t_375 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_17 _t_374))
(define-fun _t_376 () (_ SFXP 32 16) (sfxp.add Wrapping _t_372 _t_375))
(define-fun _t_379 () (_ SFXP 32 16) (sfxp #x000094fd 16))
(define-fun _t_380 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_21 _t_379))
(define-fun _t_381 () (_ SFXP 32 16) (sfxp.add Wrapping _t_376 _t_380))
(define-fun _t_382 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_25 _t_366))
...
(define-fun _t_394 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardNegative _t_13 _t_393))
