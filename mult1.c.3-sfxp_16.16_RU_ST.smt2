...
(define-fun _t_21 () Bool (sfxp.lt _t_10 _t_20))
(define-fun _t_22 () Bool (and _t_19 _t_21))
(define-fun _t_23 () Bool (sfxp.lt _t_9 _t_12))
(define-fun _t_24 () Bool (and _t_22 _t_23))
(define-fun _t_25 () Bool (sfxp.lt _t_12 _t_20))
(define-fun _t_26 () Bool (and _t_24 _t_25))
(define-fun _t_27 () Bool (sfxp.lt _t_9 _t_14))
(define-fun _t_28 () Bool (and _t_26 _t_27))
(define-fun _t_29 () Bool (sfxp.lt _t_14 _t_20))
