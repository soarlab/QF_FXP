...
(define-fun _t_33 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_13 _t_32))
...
(define-fun _t_51 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_13 _t_50))
(define-fun _t_52 () (_ SFXP 32 16) (sfxp.add Wrapping _t_26 _t_51))
(define-fun _t_54 () (_ SFXP 32 16) (sfxp #x0000c395 16))
(define-fun _t_55 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_17 _t_54))
...
(define-fun _t_100 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_13 _t_99))
(define-fun _t_101 () (_ SFXP 32 16) (sfxp.add Wrapping _t_26 _t_100))
(define-fun _t_104 () (_ SFXP 32 16) (sfxp #x000064dd 16))
(define-fun _t_105 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_17 _t_104))
(define-fun _t_106 () (_ SFXP 32 16) (sfxp.add Wrapping _t_101 _t_105))
(define-fun _t_108 () (_ SFXP 32 16) (sfxp #x0000eed9 16))
(define-fun _t_109 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_21 _t_108))
...
(define-fun _t_136 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_13 _t_135))
(define-fun _t_137 () (_ SFXP 32 16) (sfxp.add Wrapping _t_26 _t_136))
(define-fun _t_140 () (_ SFXP 32 16) (sfxp #x0000ed0e 16))
(define-fun _t_141 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_17 _t_140))
(define-fun _t_142 () (_ SFXP 32 16) (sfxp.add Wrapping _t_137 _t_141))
(define-fun _t_144 () (_ SFXP 32 16) (sfxp #x0000b8d4 16))
(define-fun _t_145 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_21 _t_144))
