...
(define-fun _t_29 () (_ SFXP 32 16) (sfxp #x00004624 16))
(define-fun _t_32 () (_ SFXP 32 16) (sfxp #x00005333 16))
...
(define-fun _t_36 () (_ SFXP 32 16) (sfxp #x0000feb8 16))
...
(define-fun _t_40 () (_ SFXP 32 16) (sfxp #x0000ef1a 16))
...
(assert _t_43)
(define-fun _t_46 () (_ SFXP 32 16) (sfxp #x000046e9 16))
(define-fun _t_49 () (_ SFXP 32 16) (sfxp #x00003062 16))
(define-fun _t_50 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_13 _t_49))
(define-fun _t_51 () (_ SFXP 32 16) (sfxp.add Saturated _t_26 _t_50))
(define-fun _t_53 () (_ SFXP 32 16) (sfxp #x0000add2 16))
...
(define-fun _t_58 () (_ SFXP 32 16) (sfxp #x00001be7 16))
...
(assert _t_61)
(define-fun _t_63 () (_ SFXP 32 16) (sfxp #x0000ce14 16))
(define-fun _t_66 () (_ SFXP 32 16) (sfxp #x0000c2d0 16))
...
(define-fun _t_70 () (_ SFXP 32 16) (sfxp #x00006a7e 16))
...
(define-fun _t_74 () (_ SFXP 32 16) (sfxp #x0000fb22 16))
