...
(assert (= (sfxp.div Saturated roundTowardNegative (sfxp #x00010000 16) (sfxp #x00000000 16)) |c::plus_infinity&0#1|))
(assert (= (sfxp.div Saturated roundTowardNegative (sfxp #x00000000 16) (sfxp.neg Saturated (sfxp #x00000000 16))) |c::minus_infinity&0#1|))
(assert (= (sfxp.mul Saturated roundTowardNegative (sfxp #x00000000 16) (sfxp.div Saturated roundTowardNegative (sfxp #x00010000 16) (sfxp #x00000000 16))) |c::NaN&0#1|))
