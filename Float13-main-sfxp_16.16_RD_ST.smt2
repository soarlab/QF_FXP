...
(assert (= (sfxp.div saturation roundDown ((_ sfxp 16) #x00010000) ((_ sfxp 16) #x00000000)) |c::plus_infinity&0#1|))
(assert (= (sfxp.div saturation roundDown ((_ sfxp 16) #x00000000) (sfxp.neg saturation ((_ sfxp 16) #x00000000))) |c::minus_infinity&0#1|))
(assert (= (sfxp.mul saturation roundDown ((_ sfxp 16) #x00000000) (sfxp.div saturation roundDown ((_ sfxp 16) #x00010000) ((_ sfxp 16) #x00000000))) |c::NaN&0#1|))
...
(assert (= (sfxp.gt |c::NaN&0#1| ((_ sfxp 16) #x00000000)) |c::main::main::1::temp@1!0&0#7|))
(assert (= (not |c::main::main::1::temp@1!0&0#7|) |c::main::$tmp::tmp$13@1!0&0#1|))
(assert (= (sfxp.lt |c::NaN&0#1| ((_ sfxp 16) #x00000000)) |c::main::main::1::temp@1!0&0#8|))
