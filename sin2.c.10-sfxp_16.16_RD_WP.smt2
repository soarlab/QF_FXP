...
(define-fun _t_117 () (_ SFXP 32 16) (sfxp.add wrapAround _t_9 _t_16))
(define-fun _t_118 () (_ SFXP 32 16) (sfxp.add wrapAround _t_24 _t_117))
(define-fun _t_119 () (_ SFXP 32 16) (sfxp.add wrapAround _t_32 _t_118))
(define-fun _t_120 () (_ SFXP 32 16) (sfxp.add wrapAround _t_40 _t_119))
(define-fun _t_121 () (_ SFXP 32 16) (sfxp.add wrapAround _t_48 _t_120))
(define-fun _t_122 () (_ SFXP 32 16) (sfxp.add wrapAround _t_56 _t_121))
(define-fun _t_123 () (_ SFXP 32 16) (sfxp.add wrapAround _t_64 _t_122))
(define-fun _t_124 () (_ SFXP 32 16) (sfxp.add wrapAround _t_72 _t_123))
(define-fun _t_125 () (_ SFXP 32 16) (sfxp.add wrapAround _t_80 _t_124))
(define-fun _t_126 () (_ SFXP 32 16) (sfxp.add wrapAround _t_88 _t_125))
...
(define-fun _t_138 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_9))
...
(define-fun _t_145 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_92))
...
(define-fun _t_228 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_88))
...
(define-fun _t_235 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_80))
...
(define-fun _t_242 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_72))
...
(define-fun _t_249 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_64))
...
(define-fun _t_256 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_56))
...
(define-fun _t_263 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_48))
...
(define-fun _t_270 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_40))
...
(define-fun _t_277 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_32))
...
(define-fun _t_284 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_24))
...
(define-fun _t_291 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_16))
