...
(define-fun _t_10 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_9))
(define-fun _t_11 () (_ SFXP 32 16) b10)
(define-fun _t_12 () (_ SFXP 32 16) (sfxp.add wrapAround _t_10 _t_11))
(define-fun _t_13 () (_ SFXP 32 16) b17)
(define-fun _t_14 () Bool (sfxp.lt _t_12 _t_13))
(define-fun _t_15 () (_ SFXP 32 16) b20)
(define-fun _t_16 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_11 _t_15))
(define-fun _t_17 () (_ SFXP 32 16) b13)
(define-fun _t_18 () (_ SFXP 32 16) (sfxp.add wrapAround _t_13 _t_17))
(define-fun _t_19 () Bool (sfxp.lt _t_18 _t_16))
(define-fun _t_20 () Bool (and _t_14 _t_19))
(define-fun _t_21 () (_ SFXP 32 16) (sfxp.add wrapAround _t_9 _t_11))
