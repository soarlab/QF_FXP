...
(define-fun _t_22 () (_ SFXP 32 16) (sfxp.add Saturation _t_20 _t_21))
...
(define-fun _t_27 () (_ SFXP 32 16) (sfxp.add Saturation _t_17 _t_26))
(define-fun _t_28 () Bool (sfxp.lt _t_27 _t_21))
(define-fun _t_29 () Bool (not _t_28))
(define-fun _t_30 () (_ SFXP 32 16) (sfxp.mul Saturation _t_3 _t_17 _t_25))
(define-fun _t_31 () Bool (sfxp.lt _t_30 _t_20))
(define-fun _t_32 () Bool (not _t_31))
(define-fun _t_33 () (_ SFXP 32 16) (sfxp.add Saturation _t_17 _t_25))
...
(define-fun _t_58 () (_ SFXP 32 16) (sfxp.add Saturation _t_9 _t_13))
