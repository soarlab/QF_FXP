...
(assert (= (sfxp.div Wrapping roundTowardNegative |c::main::main::1::a@1!0&0#0| (sfxp #x00020000 16)) |c::main::main::1::a@1!0&0#1|))
(assert (= (sfxp.mul Wrapping roundTowardNegative |c::main::main::1::a@1!0&0#1| (sfxp #x00020000 16)) |c::main::main::1::a@1!0&0#2|))
