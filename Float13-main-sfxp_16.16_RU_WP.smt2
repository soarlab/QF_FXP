...
(assert (= (sfxp.div wrapAround roundUp ((_ sfxp 16) #x00010000) ((_ sfxp 16) #x00000000)) |c::plus_infinity&0#1|))
(assert (= (sfxp.div wrapAround roundUp ((_ sfxp 16) #x00000000) (sfxp.neg wrapAround ((_ sfxp 16) #x00000000))) |c::minus_infinity&0#1|))
(assert (= (sfxp.mul wrapAround roundUp ((_ sfxp 16) #x00000000) (sfxp.div wrapAround roundUp ((_ sfxp 16) #x00010000) ((_ sfxp 16) #x00000000))) |c::NaN&0#1|))
