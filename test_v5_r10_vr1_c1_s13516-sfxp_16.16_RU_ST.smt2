...
(define-fun _t_154 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_21 _t_153))
(define-fun _t_155 () (_ SFXP 32 16) (sfxp.add Saturated _t_150 _t_154))
(define-fun _t_158 () (_ SFXP 32 16) (sfxp #x00005a1c 16))
(define-fun _t_159 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_25 _t_158))
(define-fun _t_160 () (_ SFXP 32 16) (sfxp.add Saturated _t_155 _t_159))
(define-fun _t_163 () (_ SFXP 32 16) (sfxp #x0000849b 16))
(define-fun _t_164 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_29 _t_163))
...
(define-fun _t_199 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_13 _t_198))
(define-fun _t_200 () (_ SFXP 32 16) (sfxp.add Saturated _t_34 _t_199))
(define-fun _t_202 () (_ SFXP 32 16) (sfxp #x00002106 16))
(define-fun _t_203 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_17 _t_202))
(define-fun _t_204 () (_ SFXP 32 16) (sfxp.add Saturated _t_200 _t_203))
(define-fun _t_207 () (_ SFXP 32 16) (sfxp #x00004312 16))
(define-fun _t_208 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_21 _t_207))
(define-fun _t_209 () (_ SFXP 32 16) (sfxp.add Saturated _t_204 _t_208))
(define-fun _t_212 () (_ SFXP 32 16) (sfxp #x00007ef9 16))
(define-fun _t_213 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_25 _t_212))
(define-fun _t_214 () (_ SFXP 32 16) (sfxp.add Saturated _t_209 _t_213))
(define-fun _t_217 () (_ SFXP 32 16) (sfxp #x0000f645 16))
(define-fun _t_218 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_29 _t_217))
...
(define-fun _t_226 () (_ SFXP 32 16) (sfxp.add Saturated _t_34 _t_225))
...
(define-fun _t_234 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_21 _t_233))
...
(define-fun _t_253 () (_ SFXP 32 16) (sfxp.add Saturated _t_34 _t_252))
...
(define-fun _t_278 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_13 _t_277))
(define-fun _t_279 () (_ SFXP 32 16) (sfxp.add Saturated _t_34 _t_278))
(define-fun _t_281 () (_ SFXP 32 16) (sfxp #x00008d0e 16))
(define-fun _t_282 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_17 _t_281))
(define-fun _t_283 () (_ SFXP 32 16) (sfxp.add Saturated _t_279 _t_282))
(define-fun _t_286 () (_ SFXP 32 16) (sfxp #x0000851e 16))
(define-fun _t_287 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_21 _t_286))
(define-fun _t_288 () (_ SFXP 32 16) (sfxp.add Saturated _t_283 _t_287))
(define-fun _t_291 () (_ SFXP 32 16) (sfxp #x0000fb22 16))
(define-fun _t_292 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardPositive _t_25 _t_291))
