...
(define-fun _t_154 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_13 _t_153))
(define-fun _t_155 () (_ SFXP 32 16) (sfxp.add Wrapping _t_42 _t_154))
...
(define-fun _t_209 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_29 _t_208))
(define-fun _t_210 () (_ SFXP 32 16) (sfxp.add Wrapping _t_206 _t_209))
(define-fun _t_213 () (_ SFXP 32 16) (sfxp #x00005ba5 16))
(define-fun _t_214 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_33 _t_213))
...
(define-fun _t_251 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_33 _t_250))
(define-fun _t_252 () (_ SFXP 32 16) (sfxp.add Wrapping _t_247 _t_251))
(define-fun _t_255 () (_ SFXP 32 16) (sfxp #x0000228f 16))
(define-fun _t_256 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_37 _t_255))
...
(define-fun _t_265 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_13 _t_264))
(define-fun _t_266 () (_ SFXP 32 16) (sfxp.add Wrapping _t_42 _t_265))
(define-fun _t_268 () (_ SFXP 32 16) (sfxp #x0000bc6a 16))
(define-fun _t_269 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_17 _t_268))
(define-fun _t_270 () (_ SFXP 32 16) (sfxp.add Wrapping _t_266 _t_269))
(define-fun _t_272 () (_ SFXP 32 16) (sfxp #x0000620c 16))
(define-fun _t_273 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_21 _t_272))
(define-fun _t_274 () (_ SFXP 32 16) (sfxp.add Wrapping _t_270 _t_273))
(define-fun _t_276 () (_ SFXP 32 16) (sfxp #x0000b581 16))
(define-fun _t_277 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_25 _t_276))
(define-fun _t_278 () (_ SFXP 32 16) (sfxp.add Wrapping _t_274 _t_277))
(define-fun _t_281 () (_ SFXP 32 16) (sfxp #x0000b645 16))
(define-fun _t_282 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_29 _t_281))
(define-fun _t_283 () (_ SFXP 32 16) (sfxp.add Wrapping _t_278 _t_282))
(define-fun _t_286 () (_ SFXP 32 16) (sfxp #x00000bc6 16))
(define-fun _t_287 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_33 _t_286))
(define-fun _t_288 () (_ SFXP 32 16) (sfxp.add Wrapping _t_283 _t_287))
(define-fun _t_291 () (_ SFXP 32 16) (sfxp #x00007893 16))
(define-fun _t_292 () (_ SFXP 32 16) (sfxp.mul Wrapping roundTowardPositive _t_37 _t_291))
