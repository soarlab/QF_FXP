...
(define-fun _t_216 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_204))
...
(define-fun _t_223 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_199))
...
(define-fun _t_238 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_179))
...
(define-fun _t_252 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_159))
...
(define-fun _t_266 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_139))
...
(define-fun _t_280 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_119))
...
(define-fun _t_294 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_99))
...
(define-fun _t_308 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_79))
...
(define-fun _t_322 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_59))
...
(define-fun _t_339 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_39))
...
(define-fun _t_346 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_26))
