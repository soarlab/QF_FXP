...
(define-fun _t_36 () (_ SFXP 32 16) (sfxp #x00009851 16))
(define-fun _t_39 () (_ SFXP 32 16) (sfxp #x00000b02 16))
...
(define-fun _t_43 () (_ SFXP 32 16) (sfxp #x00008395 16))
...
(define-fun _t_48 () (_ SFXP 32 16) (sfxp #x000099db 16))
...
(define-fun _t_53 () (_ SFXP 32 16) (sfxp #x000075c2 16))
...
(define-fun _t_58 () (_ SFXP 32 16) (sfxp #x00000f5c 16))
...
(assert _t_61)
(define-fun _t_64 () (_ SFXP 32 16) (sfxp #x00005d2f 16))
(define-fun _t_66 () (_ SFXP 32 16) (sfxp #x0000ad0e 16))
...
(define-fun _t_70 () (_ SFXP 32 16) (sfxp #x00001916 16))
...
(define-fun _t_75 () (_ SFXP 32 16) (sfxp #x0000178d 16))
...
(define-fun _t_79 () (_ SFXP 32 16) (sfxp #x0000beb8 16))
...
(define-fun _t_83 () (_ SFXP 32 16) (sfxp #x00004666 16))
...
(assert _t_86)
(define-fun _t_89 () (_ SFXP 32 16) (sfxp #x0000b47a 16))
(define-fun _t_91 () (_ SFXP 32 16) (sfxp #x00004937 16))
...
(define-fun _t_95 () (_ SFXP 32 16) (sfxp #x0000ad4f 16))
...
(define-fun _t_100 () (_ SFXP 32 16) (sfxp #x0000876c 16))
...
(define-fun _t_105 () (_ SFXP 32 16) (sfxp #x0000778d 16))
...
(define-fun _t_109 () (_ SFXP 32 16) (sfxp #x00007b22 16))
...
(assert _t_112)
(define-fun _t_114 () (_ SFXP 32 16) (sfxp #x00006666 16))
(define-fun _t_116 () (_ SFXP 32 16) (sfxp #x0000f851 16))
...
(define-fun _t_120 () (_ SFXP 32 16) (sfxp #x00007020 16))
...
(define-fun _t_125 () (_ SFXP 32 16) (sfxp #x0000f53f 16))
...
(define-fun _t_130 () (_ SFXP 32 16) (sfxp #x00004e56 16))
...
(define-fun _t_134 () (_ SFXP 32 16) (sfxp #x0000cb02 16))
...
(assert _t_137)
(define-fun _t_139 () (_ SFXP 32 16) (sfxp #x0000e353 16))
(define-fun _t_141 () (_ SFXP 32 16) (sfxp #x00007ef9 16))
...
(define-fun _t_146 () (_ SFXP 32 16) (sfxp #x0000651e 16))
...
(define-fun _t_151 () (_ SFXP 32 16) (sfxp #x00006d4f 16))
...
(define-fun _t_155 () (_ SFXP 32 16) (sfxp #x0000c28f 16))
...
(define-fun _t_160 () (_ SFXP 32 16) (sfxp #x000076c8 16))
