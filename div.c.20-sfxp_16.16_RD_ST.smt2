...
(define-fun _t_10 () (_ SFXP 32 16) b119)
...
(define-fun _t_107 () Bool (sfxp.leq _t_52 _t_38))
...
(define-fun _t_111 () Bool (sfxp.leq _t_52 _t_40))
...
(define-fun _t_115 () Bool (sfxp.leq _t_52 _t_42))
...
(define-fun _t_119 () Bool (sfxp.leq _t_52 _t_44))
...
(define-fun _t_123 () Bool (sfxp.leq _t_52 _t_46))
...
(define-fun _t_127 () Bool (sfxp.leq _t_52 _t_48))
...
(define-fun _t_131 () Bool (sfxp.leq _t_52 _t_50))
