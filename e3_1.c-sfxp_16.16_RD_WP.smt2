...
(define-fun _t_15 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_10 _t_14))
(define-fun _t_16 () (_ SFXP 32 16) b19)
(define-fun _t_17 () (_ SFXP 32 16) (sfxp.add wrapAround _t_12 _t_16))
(define-fun _t_18 () Bool (sfxp.lt _t_17 _t_15))
(define-fun _t_19 () Bool (and _t_13 _t_18))
(define-fun _t_20 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_9 _t_10))
(define-fun _t_21 () Bool (sfxp.lt _t_20 _t_12))
(define-fun _t_22 () Bool (and _t_19 _t_21))
(define-fun _t_23 () (_ SFXP 32 16) (sfxp.neg wrapAround _t_9))
(define-fun _t_24 () (_ SFXP 32 16) (sfxp.add wrapAround _t_10 _t_23))
