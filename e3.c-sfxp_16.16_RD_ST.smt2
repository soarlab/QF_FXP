...
(define-fun _t_22 () (_ SFXP 32 16) (sfxp.add Saturated _t_20 _t_21))
...
(define-fun _t_30 () (_ SFXP 32 16) (sfxp.mul Saturated roundTowardNegative _t_17 _t_25))
(define-fun _t_31 () Bool (sfxp.lt _t_30 _t_20))
(define-fun _t_32 () Bool (not _t_31))
(define-fun _t_33 () (_ SFXP 32 16) (sfxp.add Saturated _t_17 _t_25))
...
(define-fun _t_58 () (_ SFXP 32 16) (sfxp.add Saturated _t_9 _t_13))
