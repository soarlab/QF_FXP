...
(define-fun _t_29 () (_ SFXP 32 16) ((_ sfxp 16) #x00004624))
(define-fun _t_32 () (_ SFXP 32 16) ((_ sfxp 16) #x00005333))
...
(define-fun _t_36 () (_ SFXP 32 16) ((_ sfxp 16) #x0000feb8))
...
(define-fun _t_40 () (_ SFXP 32 16) ((_ sfxp 16) #x0000ef1a))
...
(assert _t_43)
(define-fun _t_46 () (_ SFXP 32 16) ((_ sfxp 16) #x000046e9))
(define-fun _t_49 () (_ SFXP 32 16) ((_ sfxp 16) #x00003062))
...
(define-fun _t_53 () (_ SFXP 32 16) ((_ sfxp 16) #x0000add2))
...
(define-fun _t_58 () (_ SFXP 32 16) ((_ sfxp 16) #x00001be7))
...
(assert _t_61)
(define-fun _t_63 () (_ SFXP 32 16) ((_ sfxp 16) #x0000ce14))
(define-fun _t_66 () (_ SFXP 32 16) ((_ sfxp 16) #x0000c2d0))
...
(define-fun _t_70 () (_ SFXP 32 16) ((_ sfxp 16) #x00006a7e))
...
(define-fun _t_74 () (_ SFXP 32 16) ((_ sfxp 16) #x0000fb22))
