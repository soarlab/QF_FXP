...
(assert (= (sfxp.div saturation roundDown |c::main::main::1::a@1!0&0#0| ((_ sfxp 16) #x00020000)) |c::main::main::1::a@1!0&0#1|))
(assert (= (sfxp.mul saturation roundDown |c::main::main::1::a@1!0&0#1| ((_ sfxp 16) #x00020000)) |c::main::main::1::a@1!0&0#2|))
