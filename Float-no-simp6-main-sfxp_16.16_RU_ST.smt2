...
(assert (= (sfxp.mul Saturation roundTowardPositive (sfxp #x00008000 16) (sfxp #x00000000 16)) |c::main::multiply::1::res@1!0&0#1|))
(assert (= (= |c::main::multiply::1::res@1!0&0#1| (sfxp #x00000000 16)) |c::multiply::$tmp::tmp$1@1!0&0#1|))
(assert (= (sfxp.div Saturation roundTowardPositive (sfxp #x00000000 16) (sfxp #x00020000 16)) |c::main::divide::1::res@1!0&0#1|))
