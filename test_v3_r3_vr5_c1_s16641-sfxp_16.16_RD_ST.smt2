...
(define-fun _t_28 () (_ SFXP 32 16) ((_ sfxp 16) #x0000f47a))
(define-fun _t_30 () (_ SFXP 32 16) ((_ sfxp 16) #x00000041))
...
(define-fun _t_35 () (_ SFXP 32 16) ((_ sfxp 16) #x0000fe35))
...
(define-fun _t_40 () (_ SFXP 32 16) ((_ sfxp 16) #x000094bc))
...
(assert _t_43)
(define-fun _t_45 () (_ SFXP 32 16) ((_ sfxp 16) #x0000e76c))
(define-fun _t_48 () (_ SFXP 32 16) ((_ sfxp 16) #x0000a0c4))
...
(define-fun _t_52 () (_ SFXP 32 16) ((_ sfxp 16) #x0000e76c))
...
(define-fun _t_57 () (_ SFXP 32 16) ((_ sfxp 16) #x00000560))
...
(assert _t_60)
(define-fun _t_62 () (_ SFXP 32 16) ((_ sfxp 16) #x0000f0e5))
(define-fun _t_64 () (_ SFXP 32 16) ((_ sfxp 16) #x000010a3))
...
(define-fun _t_68 () (_ SFXP 32 16) ((_ sfxp 16) #x0000b439))
...
(define-fun _t_72 () (_ SFXP 32 16) ((_ sfxp 16) #x0000472b))
