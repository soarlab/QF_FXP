...
(define-fun _t_28 () (_ SFXP 32 16) ((_ sfxp 16) #x00003e76))
(define-fun _t_31 () (_ SFXP 32 16) ((_ sfxp 16) #x0000f020))
...
(define-fun _t_36 () (_ SFXP 32 16) ((_ sfxp 16) #x0000cc8b))
...
(define-fun _t_40 () (_ SFXP 32 16) ((_ sfxp 16) #x0000e666))
...
(assert _t_43)
(define-fun _t_45 () (_ SFXP 32 16) ((_ sfxp 16) #x00004666))
(define-fun _t_47 () (_ SFXP 32 16) ((_ sfxp 16) #x00000147))
...
(define-fun _t_51 () (_ SFXP 32 16) ((_ sfxp 16) #x0000ef5c))
...
(define-fun _t_56 () (_ SFXP 32 16) ((_ sfxp 16) #x00004b85))
...
(assert _t_59)
(define-fun _t_62 () (_ SFXP 32 16) ((_ sfxp 16) #x00000937))
(define-fun _t_64 () (_ SFXP 32 16) ((_ sfxp 16) #x00005645))
...
(define-fun _t_68 () (_ SFXP 32 16) ((_ sfxp 16) #x0000a5e3))
...
(define-fun _t_73 () (_ SFXP 32 16) ((_ sfxp 16) #x000024dd))
