...
(assert (= (sfxp.div Saturation roundTowardPositive (sfxp #x00010000 16) (sfxp #x00000000 16)) |c::plus_infinity&0#1|))
(assert (= (sfxp.div Saturation roundTowardPositive (sfxp #x00000000 16) (sfxp.neg Saturation (sfxp #x00000000 16))) |c::minus_infinity&0#1|))
(assert (= (sfxp.mul Saturation roundTowardPositive (sfxp #x00000000 16) (sfxp.div Saturation roundTowardPositive (sfxp #x00010000 16) (sfxp #x00000000 16))) |c::NaN&0#1|))
