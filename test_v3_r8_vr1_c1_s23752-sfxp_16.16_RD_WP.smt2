...
(define-fun _t_28 () (_ SFXP 32 16) ((_ sfxp 16) #x00000d4f))
(define-fun _t_30 () (_ SFXP 32 16) ((_ sfxp 16) #x000050e5))
...
(define-fun _t_35 () (_ SFXP 32 16) ((_ sfxp 16) #x0000851e))
...
(define-fun _t_40 () (_ SFXP 32 16) ((_ sfxp 16) #x00000f5c))
...
(assert _t_43)
(define-fun _t_45 () (_ SFXP 32 16) ((_ sfxp 16) #x00002147))
(define-fun _t_48 () (_ SFXP 32 16) ((_ sfxp 16) #x0000f6c8))
...
(define-fun _t_53 () (_ SFXP 32 16) ((_ sfxp 16) #x0000220c))
...
(define-fun _t_58 () (_ SFXP 32 16) ((_ sfxp 16) #x000059db))
...
(assert _t_61)
(define-fun _t_63 () (_ SFXP 32 16) ((_ sfxp 16) #x00005ae1))
(define-fun _t_66 () (_ SFXP 32 16) ((_ sfxp 16) #x00004f5c))
...
(define-fun _t_70 () (_ SFXP 32 16) ((_ sfxp 16) #x0000024d))
...
(define-fun _t_75 () (_ SFXP 32 16) ((_ sfxp 16) #x000074fd))
...
(assert _t_78)
(define-fun _t_79 () (_ SFXP 32 16) ((_ sfxp 16) #x000059db))
(define-fun _t_82 () (_ SFXP 32 16) ((_ sfxp 16) #x000095c2))
(define-fun _t_85 () (_ SFXP 32 16) ((_ sfxp 16) #x00001916))
(define-fun _t_86 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_13 _t_85))
(define-fun _t_87 () (_ SFXP 32 16) (sfxp.add wrapAround _t_26 _t_86))
(define-fun _t_88 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_17 _t_79))
(define-fun _t_89 () (_ SFXP 32 16) (sfxp.add wrapAround _t_87 _t_88))
(define-fun _t_91 () (_ SFXP 32 16) ((_ sfxp 16) #x00009d70))
...
(assert _t_94)
(define-fun _t_96 () (_ SFXP 32 16) ((_ sfxp 16) #x0000c51e))
(define-fun _t_98 () (_ SFXP 32 16) ((_ sfxp 16) #x00003999))
...
(define-fun _t_103 () (_ SFXP 32 16) ((_ sfxp 16) #x00002831))
...
(define-fun _t_108 () (_ SFXP 32 16) ((_ sfxp 16) #x0000a978))
...
(assert _t_111)
(define-fun _t_113 () (_ SFXP 32 16) ((_ sfxp 16) #x00006937))
(define-fun _t_116 () (_ SFXP 32 16) ((_ sfxp 16) #x00007958))
(define-fun _t_117 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_13 _t_116))
(define-fun _t_118 () (_ SFXP 32 16) (sfxp.add wrapAround _t_26 _t_117))
(define-fun _t_120 () (_ SFXP 32 16) ((_ sfxp 16) #x000086e9))
...
(define-fun _t_125 () (_ SFXP 32 16) ((_ sfxp 16) #x00005c28))
...
(assert _t_128)
(define-fun _t_131 () (_ SFXP 32 16) ((_ sfxp 16) #x0000276c))
(define-fun _t_134 () (_ SFXP 32 16) ((_ sfxp 16) #x00001c6a))
(define-fun _t_135 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_13 _t_134))
(define-fun _t_136 () (_ SFXP 32 16) (sfxp.add wrapAround _t_26 _t_135))
(define-fun _t_139 () (_ SFXP 32 16) ((_ sfxp 16) #x00005a5e))
(define-fun _t_140 () (_ SFXP 32 16) (sfxp.mul wrapAround _t_3 _t_17 _t_139))
(define-fun _t_141 () (_ SFXP 32 16) (sfxp.add wrapAround _t_136 _t_140))
(define-fun _t_144 () (_ SFXP 32 16) ((_ sfxp 16) #x000061ca))
...
(assert _t_147)
(define-fun _t_149 () (_ SFXP 32 16) ((_ sfxp 16) #x0000d020))
(define-fun _t_152 () (_ SFXP 32 16) ((_ sfxp 16) #x000011eb))
...
(define-fun _t_156 () (_ SFXP 32 16) ((_ sfxp 16) #x000067ef))
...
(define-fun _t_160 () (_ SFXP 32 16) ((_ sfxp 16) #x00003333))
