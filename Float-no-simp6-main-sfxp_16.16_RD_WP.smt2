...
(assert (= (sfxp.mul wrapAround roundDown ((_ sfxp 16) #x00008000) ((_ sfxp 16) #x00000000)) |c::main::multiply::1::res@1!0&0#1|))
(assert (= (= |c::main::multiply::1::res@1!0&0#1| ((_ sfxp 16) #x00000000)) |c::multiply::$tmp::tmp$1@1!0&0#1|))
(assert (= (sfxp.div wrapAround roundDown ((_ sfxp 16) #x00000000) ((_ sfxp 16) #x00020000)) |c::main::divide::1::res@1!0&0#1|))
